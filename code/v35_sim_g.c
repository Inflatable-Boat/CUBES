...
const char labelstring[] = "v35_%02d_pf%04.2lf_p%04.1lf_a%04.2lf";
// CubesPerDim, pack_frac, BetaP, Phi, order_mode, order_cutoff
// if p == -1, it means NVT ensemble
const char usage_string[] = "\nusage: v35.exe r/c readf/#cube outputf/pf #steps #outsteps p/nvt phi\n\
...
// make the folder to store all the data in, if it already exists do nothing.
    ...
    for (int step = 0; step <= 100000; step++) { // 100000 equilibration sweeps
