...
//////////////////////////////////////////////////////////////// my additions
const char labelstring[] = "v3_%02dpf%04.2lfp%04.1lfa%04.2lf";
...
huh this message shouldn't be visible\n");
        ...
        printf("%4.1lf%%\t(step %d of %d)", 100.0 * step / mc_steps, step, mc_steps);
    }
    printf("\n");
