...
// a.exe mc_steps Phi
int mc_steps;
double BetaP = 1; // start at one, increase 10 every 10k steps after fluids_steps = 10000 mc_steps
double Phi; // angle of slanted cube

const char labelstring[] = "v13_%02da%04.2lf";
// e.g. sl10a1.25:
...
void set_packing_fraction(void)
{
    ...
    double target_volume = (n_particles * ParticleVolume) / 0.1; // target packing fraction is 0.1
