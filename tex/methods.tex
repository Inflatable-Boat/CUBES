...
%To study nucleation of hard cubes, the system we will be using is a system of $N$ hard cubes at a pressure $p$ and temperature $T$. Because we are not interested in surface effects, we simulate the bulk by using periodic boundary conditions.
...
The main goal of a Monte Carlo simulation is to approximate ensemble averages such as\todo{how to cite course notes?}
\begin{equation}
